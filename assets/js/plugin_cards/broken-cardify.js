...
function scrapePage(html, link) {
  ...
  if (url && title && desc) {
    ...
    if (cardDiv && parentNode) {
      ...
      if (linkText.length > 0 && !linkText.endsWith('…')) {
        parentNode.insertBefore(document.createTextNode(linkText), link)
      }
